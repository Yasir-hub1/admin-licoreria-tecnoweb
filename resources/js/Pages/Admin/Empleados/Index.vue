    ...
    <MainLayout>
        <div class="container mx-auto px-4 py-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <Link href="/admin/empleados/create" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium">
                    ➕ Nuevo Empleado
                </Link>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="empleado in empleados.data" :key="empleado.id">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <Link :href="`/admin/empleados/${empleado.id}`" class="text-blue-600 hover:text-blue-900">Ver</Link>
                                <Link :href="`/admin/empleados/${empleado.id}/edit`" class="text-indigo-600 hover:text-indigo-900">Editar</Link>
                                <button @click="deleteItem(empleado.id)" class="text-red-600 hover:text-red-900">Eliminar</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
